...
(function ($) {
  ...
  function petri_navigation() {
    ...
    if (!(1199 >= getWindowWidth() || $body.hasClass("mobile"))) {
      ...
      if (
        $body.hasClass("mCS_destroyed") ||
        !$body.hasClass("mCustomScrollbar")
      ) {
        $body.mCustomScrollbar({
          ...
          callbacks: {
            whileScrolling: function () {
              ...
              if (
                $body.hasClass("side-block-open") ||
                !$body.hasClass("has-hide-side-block")
              ) {
                if (this.mcs.top <= -100) {
            ...
            onScroll: function () {
              if (!$body.hasClass("side-block-open")) return true;
            },
          },
        });
    ...
    if (
      ...
      document.querySelectorAll("video[autoplay]").length > 0 &&
      ($body.hasClass("mCustomScrollbar") || $body.hasClass("mCS_destroyed"))
    ) {
    ...
    if (
      $siteHeader.hasClass("header-classic-mobile-fixed") ||
      $siteHeader.hasClass("header-overlay-navigation")
    ) {
      if (1199 >= getWindowWidth()) {
        ...
        $body
          ...
          .css(
            "padding-top",
            parseInt($body.find("section").first().css("padding-top"), 10) +
              headerBaseHeight
          );
      }
    }
    ...
    if ($siteHeader.hasClass("header-overlay-navigation")) {
      ...
      $siteHeader
        .find(".overlay-navigation-container")
        .first()
        .css("height", "")
        .css("margin-top", "");
      $siteHeader
        .find(".overlay-navigation-container nav")
        .first()
        .css("min-height", "");
      $siteHeader
        .find(".overlay-navigation-container")
        .first()
        .css("height", getWindowHeight() - parseInt(headerBaseHeight, 10))
        .css("margin-top", parseInt(headerBaseHeight, 10));
      $siteHeader
        .find(".overlay-navigation-container nav")
        .first()
        .css("min-height", getWindowHeight() - parseInt(headerBaseHeight, 10));
    }
    ...
    $smoothScrollLinks.on("click", function (e) {
      ...
      if (!(1199 >= getWindowWidth() || $body.hasClass("mobile"))) {
        if ($(target).parents("#side-block").length > 0) {
          ...
          $("body.side-block-open").mCustomScrollbar(
            "scrollTo",
            mCustomScrollbarScrollToOffset(
          ...
          // Show - Global mask
          if (
            $globalMask.hasClass("hide-global-mask") &&
            $sideBlock.hasClass("hide-side-block")
          ) {
            $globalMask.addClass("active");
          }
        } else {
          if (
            $body.hasClass("has-side-block") &&
            $body.hasClass("side-block-open")
          ) {
        ...
        if (
          closeOverlayNavAfterClick === true &&
          $(target).parents(".site-header") &&
          $siteHeader.hasClass("header-overlay-navigation") &&
          $navToggle.hasClass("open")
        ) {
        ...
        if (
          closeClassicNavAfterClick_mobile === true &&
          $(target).parents(".site-header") &&
          $siteHeader.hasClass("header-classic-navigation") &&
          $navToggle.hasClass("open")
        ) {
          $navToggle.trigger("click");
        }
  ...
  function petri_backToTopButton() {
    ...
    $backToTop.on("click", function (e) {
      ...
      if (
        ...
        if (
          !(1199 >= getWindowWidth() || $body.hasClass("mobile")) &&
          ($body.hasClass("side-block-open") ||
            !$sideBlock.hasClass("hide-side-block"))
        ) {
          $("body.side-block-open").mCustomScrollbar(
  ...
  function petri_backgrounds() {
    ...
    if ($body.hasClass("mobile")) {
      ...
      source.setAttribute("src", "assets/videos/video2.mp4");
      ...
      source.setAttribute("src", "assets/videos/video1.mp4");
      source.setAttribute("type", "video/mp4");
  ...
  function petri_magnificPopup() {
    if (
      ...
      $(".mfp-image").magnificPopup({
        type: "image",
        closeMarkup:
          '<button title="%title%" type="button" class="mfp-close"><i class="fas fa-times"></i></button>',
        removalDelay: 300,
        mainClass: "mfp-fade",
      });
