...
$toemails[] = array(
	'email' => 'kontakt@dariuszgrzegorczyk.pl', // Your Email Address
	'name' => 'Dariusz' // Your Name
);


// Sender's Email
$fromemail = array(
	'email' => 'kontakt@dariuszgrzegorczyk.pl', // Company's Email Address (preferably currently used Domain Name)
	'name' => 'Dariusz Grzegorczyk' // Company Name
);
